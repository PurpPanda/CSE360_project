...
public class UserNameRecognizer {
	...
	public static String checkForValidUserName(String input) {
		...
		while (running) {
			...
			case 0: 
				...
				if ((currentChar >= 'A' && currentChar <= 'Z' ) ||		// Check for A-Z
						(currentChar >= 'a' && currentChar <= 'z' ) ) {	// Check for 0-9 was removed as it is no longer a required username entry
					nextState = 1;
		...
		case 0:
			...
			userNameRecognizerErrorMessage += "A UserName must start with Alaphabetical letter (Not Case Sensitive).\n";
